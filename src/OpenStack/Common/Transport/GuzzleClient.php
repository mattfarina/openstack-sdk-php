...
class GuzzleClient implements ClientInterface, \Serializable
{
     ...
     *
     * @throws \OpenStack\Common\Transport\ForbiddenException
     * @throws \OpenStack\Common\Transport\UnauthorizedException
     * @throws \OpenStack\Common\Transport\FileNotFoundException
     * @throws \OpenStack\Common\Transport\MethodNotAllowedException
     * @throws \OpenStack\Common\Transport\ConflictException
     * @throws \OpenStack\Common\Transport\LengthRequiredException
     * @throws \OpenStack\Common\Transport\UnprocessableEntityException
     * @throws \OpenStack\Common\Transport\ServerException
    ...
    protected function handleException($exception)
    {
        ...
        if (!is_null($response)) {
            ...
            switch ($code) {
                case '403':
                    throw new \OpenStack\Common\Transport\ForbiddenException($response->getReasonPhrase());
                case '401':
                    throw new \OpenStack\Common\Transport\UnauthorizedException($response->getReasonPhrase());
                case '404':
                    throw new \OpenStack\Common\Transport\FileNotFoundException($response->getReasonPhrase() . " ({$response->getEffectiveUrl()})");
                case '405':
                    throw new \OpenStack\Common\Transport\MethodNotAllowedException($response->getReasonPhrase() . " ({$request->getMethod()} {$response->getEffectiveUrl()})");
                case '409':
                    throw new \OpenStack\Common\Transport\ConflictException($response->getReasonPhrase());
                case '412':
                    throw new \OpenStack\Common\Transport\LengthRequiredException($response->getReasonPhrase());
                case '422':
                    throw new \OpenStack\Common\Transport\UnprocessableEntityException($response->getReasonPhrase());
                case '500':
                    throw new \OpenStack\Common\Transport\ServerException($response->getReasonPhrase());
                default:
